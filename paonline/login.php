...
<body style="background-image: url('paorico.png')">
    <div class="wrapper">
      <fieldset>  
        <center><h2><font size="+3">Log In</font></h2></center>
        <center><p><font size="+3">Escreva os dados precisos para a conexão.</font></p></center>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group">
                <center><label><font size="+2">Nome</label></center>
            ...
            <div class="form-group">
                <center><label><font size="+2">Senha</label></center>
            ...
            <p><a href="register.php"><font size="+2">Não tenho ninguma conta...</font></a>.</p>
        </form>
      </fieldset>
    </div>
</body>
