...
<body style="background-image: url('paorico.png')">
    <div class="wrapper">
        <fieldset>
        <center><h2><font size="+3">Registro:</font></h2></center>
        <center><p><font size="+2">Escreva os dados precisos para o seu registro.</font></p></center>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group">
                <center><label><font size="+2">Nome</font></label></center>
            ...
            <div class="form-group">
                <center><label><font size="+2">Senha</font></label></center>
            ...
            <div class="form-group">
                <center><label><font size="+2">Confirmar Senha</font></label></center>
            ...
            <p><a href="login.php"><font size="+2">Ja tenho uma conta!</a>.</p>
        </form>
        </fieldset>
    </div>    
</body>
